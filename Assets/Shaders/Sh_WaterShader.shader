...
Shader "Shader Forge/Sh_Water_Tuto" {
    Properties {
        ...
        _Tesselation ("Tesselation", Range(0, 10)) = 0.1709402
    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float4 node_7841 = _Time;
                float node_793 = (sin((node_7841.g+mul(unity_ObjectToWorld, v.vertex).r))*0.1);
                v.vertex.xyz += float3(node_793,node_793,node_793);
...
////// Specular:
                ...
                float2 node_2085 = (i.uv0+node_7918.g*float2(0.01,0.01));
...
////// Specular:
                ...
                float2 node_2085 = (i.uv0+node_4544.g*float2(0.01,0.01));
                float4 _FoamTexture_var = tex2D(_FoamTexture,TRANSFORM_TEX(node_2085, _FoamTexture));
                float node_2191 = 0.0;
                float node_2846 = (1.0 - saturate((node_2191 + ( (node_6398 - _FoamMin) * (1.0 - node_2191) ) / (_FoamMax - _FoamMin))));
                float3 node_7911 = saturate(((((node_1638*_FoamTexture_var.rgb)*node_2846)*_FoamPower)+pow(node_2846,5.0)));
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float node_6398 = saturate((saturate((sceneZ-partZ)/_Depth)/0.5*dot(viewDirection,i.normalDir)+0.5));
                float3 node_1638 = lerp(_ColorA.rgb,_ColorB.rgb,node_6398);
                float4 node_4997 = _Time;
                float2 node_2085 = (i.uv0+node_4997.g*float2(0.01,0.01));
                float4 _FoamTexture_var = tex2D(_FoamTexture,TRANSFORM_TEX(node_2085, _FoamTexture));
                float node_2191 = 0.0;
                float node_2846 = (1.0 - saturate((node_2191 + ( (node_6398 - _FoamMin) * (1.0 - node_2191) ) / (_FoamMax - _FoamMin))));
                float3 node_7911 = saturate(((((node_1638*_FoamTexture_var.rgb)*node_2846)*_FoamPower)+pow(node_2846,5.0)));
